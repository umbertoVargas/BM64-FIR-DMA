...
const ivt_t ivt[] = {
	...
	{XPAR_INTC_0_AXIDMA_0_S2MM_INTROUT_VEC_ID, (XInterruptHandler)fnS2MMInterruptHandler, &sAxiDma},
	//DMA MemoryMap to Stream Interrupt handler
	{XPAR_INTC_0_AXIDMA_0_MM2S_INTROUT_VEC_ID, (XInterruptHandler)fnMM2SInterruptHandler, &sAxiDma},
	...
	//FIFO
		{XPAR_INTC_0_LLFIFO_0_VEC_ID, (XInterruptHandler)FifoHandler, &fifo},
	//UART BM64
